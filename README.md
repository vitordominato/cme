...
- **Altas do Dia** — importa o arquivo de altas hospitalares (Base Analítica, relatório R_ALTA_MED_HOSP do MV ou export 7101) e o censo SoulMV; cruza alta × censo para score completo, ou aplica o score parcial (DIH, emergência, CID de risco, idade). Exclusões automáticas: óbito, berçário, day clinic, Z38, O80.
